    ...
    public byte[] transceive(byte[] pCommand) throws CommunicationException {
        ...
        try {
            ...
            if (mTagCom.isConnected()){
                ...
                /*Log.d("Response  len ", String.valueOf(response.length));
                Log.d("Response string", String.valueOf(response.toString()));
                Log.d("Response 0", String.valueOf(response[0]));
                Log.d("Response 1", String.valueOf(response[1]));
                Log.d("Response 2", String.valueOf(response[2]));
                Log.d("Response 3", String.valueOf(response[3]));*/
                //Log.d("bytesToString", BytesUtils.bytesToString(response));
                //.d("prettyPrintAPDUResponse", TlvUtil.prettyPrintAPDUResponse(response));
            }
        } catch (IOException e) {
